const RightMenu = ({data, ind, readCallback, read, count}) => {


    return (
        <div>
            {Object.values(data)[ind].comments.map((comment, index) => {
                return (
                    <div className={'flex flex-col border-2 border-gray-200 rounded-md mt-10'}>
                        <div className={'flex py-4 justify-center items-center rounded-t-md border-2 border-gray-200'}>
                            ...
                            <div className={'w-1/4 flex justify-center'}>
                                Post Sentiment: {Object.values(data)[ind].sentimentPolarity["0"]}
                            </div>
                            <div className={'w-1/4 flex justify-center'}>
